...
export class Init1695781161438 implements MigrationInterface {
    name = 'Init1695781161438'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "occupation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(300) NOT NULL, "years_experience" smallint DEFAULT '0', "months_experience" smallint DEFAULT '0', "professionalId" uuid NOT NULL, "professional_id" uuid, CONSTRAINT "UQ_47dc90a06f122e0b7256fa1e5fd" UNIQUE ("name"), CONSTRAINT "PK_07cfcefef555693d96dce8805c5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "users_occupations" ADD CONSTRAINT "FK_c884d18b03e6220434c3c92b8f5" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users_occupations" ADD CONSTRAINT "FK_60ecd28b9d06e9f64363e5b32db" FOREIGN KEY ("occupation_id") REFERENCES "occupation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "occupations_skills" ADD CONSTRAINT "FK_f56700053b9726ddec40ac0d455" FOREIGN KEY ("occupation_id") REFERENCES "occupation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "occupations_skills" ADD CONSTRAINT "FK_aacc01b1682109e89e4fd077b4d" FOREIGN KEY ("skill_id") REFERENCES "skill"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
