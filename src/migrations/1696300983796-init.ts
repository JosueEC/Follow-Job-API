...
export class Init1696300983796 implements MigrationInterface {
    name = 'Init1696300983796'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "company" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(255) NOT NULL, CONSTRAINT "UQ_a76c5cd486f7779bd9c319afd27" UNIQUE ("name"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "job" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(500) NOT NULL, CONSTRAINT "PK_98ab1c14ff8d1cf80d18703b92f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "location" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(500) NOT NULL, CONSTRAINT "UQ_f0336eb8ccdf8306e270d400cf0" UNIQUE ("name"), CONSTRAINT "PK_876d7bdba03c72251ec4c2dc827" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_vacancies_vacancy" ("user_id" uuid NOT NULL, "vacancy_id" uuid NOT NULL, CONSTRAINT "PK_255c398adf96cfed787e46a985d" PRIMARY KEY ("user_id", "vacancy_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9a43ad2ba10036c27bd79278c6" ON "user_vacancies_vacancy" ("user_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_b84a15440214b1c81b0ac0ecab" ON "user_vacancies_vacancy" ("vacancy_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "network" ADD CONSTRAINT "FK_aa0107a40faeabc4d6e87fb43b9" FOREIGN KEY ("vacancy_id") REFERENCES "vacancy"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vacancy" ADD CONSTRAINT "FK_461db2c402fb48580c89b26017c" FOREIGN KEY ("company_id") REFERENCES "company"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vacancy" ADD CONSTRAINT "FK_565a3005b17b601dba5750d4685" FOREIGN KEY ("job_id") REFERENCES "job"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vacancy" ADD CONSTRAINT "FK_9a5090017c31176ce8651d319bb" FOREIGN KEY ("location_id") REFERENCES "location"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vacancy" ADD CONSTRAINT "FK_ca3db66b8eb4959700c8a11a934" FOREIGN KEY ("color_id") REFERENCES "color"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "user_vacancies_vacancy" ADD CONSTRAINT "FK_9a43ad2ba10036c27bd79278c6f" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "user_vacancies_vacancy" ADD CONSTRAINT "FK_b84a15440214b1c81b0ac0ecabe" FOREIGN KEY ("vacancy_id") REFERENCES "vacancy"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_vacancies_vacancy" DROP CONSTRAINT "FK_b84a15440214b1c81b0ac0ecabe"`);
        await queryRunner.query(`ALTER TABLE "user_vacancies_vacancy" DROP CONSTRAINT "FK_9a43ad2ba10036c27bd79278c6f"`);
        ...
        await queryRunner.query(`ALTER TABLE "vacancy" DROP CONSTRAINT "FK_ca3db66b8eb4959700c8a11a934"`);
        await queryRunner.query(`ALTER TABLE "vacancy" DROP CONSTRAINT "FK_9a5090017c31176ce8651d319bb"`);
        await queryRunner.query(`ALTER TABLE "vacancy" DROP CONSTRAINT "FK_565a3005b17b601dba5750d4685"`);
        await queryRunner.query(`ALTER TABLE "vacancy" DROP CONSTRAINT "FK_461db2c402fb48580c89b26017c"`);
        await queryRunner.query(`ALTER TABLE "network" DROP CONSTRAINT "FK_aa0107a40faeabc4d6e87fb43b9"`);
        await queryRunner.query(`ALTER TABLE "network" DROP CONSTRAINT "FK_06077802d7c3c70128548814c08"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b84a15440214b1c81b0ac0ecab"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_9a43ad2ba10036c27bd79278c6"`);
        await queryRunner.query(`DROP TABLE "user_vacancies_vacancy"`);
